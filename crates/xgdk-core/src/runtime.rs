...
pub const MANIFEST_PATH: &str = "files/share/xgdk/capabilities.json";
...
pub const LIST_PATH: &str = "xgdk-capabilities.txt";
...
impl InstalledRuntime {
    ...
    pub fn discover(paths: &Paths) -> anyhow::Result<Self> {
        let dir = paths.runtime_dir().ok_or_else(|| {
            anyhow::anyhow!(
                "no patched Proton runtime found. Install one (xgdk install-runtime), \
